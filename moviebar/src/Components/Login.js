...
const Login = () => {
  ...
  return (
    <Container>
        ...
        <SearchInput type="email" name="email" placeholder="type your email" value={state.email} onChange={handleInputs} />
        <SearchInput type="password" name="password" placeholder="type your password" value={state.password} onChange={handleInputs}/>
