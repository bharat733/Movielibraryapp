...
const SignUp = () => {
  ...
  return (
    ...
    <Container>
        ...
        <SearchInput name="name" type="text" placeholder="type your name" onChange={handleInputs}/>
        <SearchInput name="email" type="email" placeholder="type your email" onChange={handleInputs}/>
