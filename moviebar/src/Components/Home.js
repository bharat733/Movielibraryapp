  ...
  return (
    <Container>
      ...
      }
      {
        ...
        <PlayListName>Your Playlist</PlayListName>
        {
          ...
          playlist.map((playlist,index)=>{
            return <>
            <Plalistheader>{playlist.listName}</Plalistheader>
      ...
      }
      {
        ...
        <PlayListName>Public Playlist Section</PlayListName>
        {
...
const Plalistheader = styled.div`
